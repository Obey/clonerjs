...
(function (BABYLONX) {
    ...
    class TexGen {
        ...
        createStraightPattern(ctx, options) {
            ...
            var count_x = options.count_x || 8;
            var count_y = options.count_y || 8;
            ...
            var half_height = height / 2.0 + 0.5;
            for (var y = 0; y < count_y + 1; y++) {
                for (var x = 0; x < count_x + 1; x++) {
                    if (x % 2 == 1) {
                        this.drawBrickRectangle(ctx, groutspace, this._brick_gradient, this._brick_color, this._grout_color, this._gradient_color, x * width, y * height - half_height, width, height);
                    }
                    else
                        this.drawBrickRectangle(ctx, groutspace, this._brick_gradient, this._brick_color, this._grout_color, this._gradient_color, x * width, y * height, width, height);
                }
            }
        }
        set brick_gradient(g) {
            this._brick_gradient = g;
            this.createStraightPattern(this._ctx, {});
        }
        get brick_gradient() {
